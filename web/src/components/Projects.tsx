      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Conheça todos os projetos desenvolvidos pelos alunos do curso de Informática 2025.2
          </p>
        </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <span className="inline-block bg-white/90 backdrop-blur-sm text-primary px-3 py-1 rounded-full text-sm font-bold">
                    Grupo {project.groupNumber}
                  </span>
                </div>
              </div>
          ...
          >
            <div className="p-4 border-b flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Grupo {selectedProject.groupNumber}</p>
              </div>
              <button
                onClick={() => setSelectedProject(null)}
